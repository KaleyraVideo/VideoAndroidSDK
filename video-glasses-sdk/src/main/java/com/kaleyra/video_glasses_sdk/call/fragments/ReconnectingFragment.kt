...
internal class ReconnectingFragment : ConnectingFragment() {
    ...
    override fun setSubtitle(isGroupCall: Boolean, isLink: Boolean) { binding.kaleyraSubtitle.text = resources.getString(R.string.kaleyra_strings_info_status_connecting) }
