 ...
 * Representation of a class capable of being started from within KaleyraVideoSDK and being used to configure KaleyraVideoSDK when required
 */
abstract class KaleyraVideoInitializer {

    /**
     * Application context provided when the class is instantiated useful for SDK configuration and connection purposes
     */
