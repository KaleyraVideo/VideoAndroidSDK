...
fun NewFileDownloadSnackbar(
    ...
    UserMessageSnackbarM3(
        message = stringResource(
            com.kaleyra.video_common_ui.R.string.kaleyra_notification_user_sharing_file,
            sender
        ),
        actionConfig = UserMessageSnackbarActionConfig(
            action = TextRef.PlainText(stringResource(R.string.kaleyra_notification_download)),
