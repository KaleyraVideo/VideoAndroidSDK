package com.kaleyra.video_sdk.call.utils.custommodifiers
...
/**
 * Custom modifier to be used to obtain fading edges in a composable
 * @receiver Modifier
 * @param scrollState ScrollState the scroll state of the composable
 * @param topEdgeHeight Dp top fading edge height
 * @param bottomEdgeHeight Dp bottom fading edge height
 * @return Modifier customized modifier with fading edges
 */
