...
internal class ScreenShareViewModel(configure: suspend () -> Configuration) : BaseViewModel<ScreenShareUiState>(configure) {
    ...
    fun shareApplicationScreen(
        ...
        onScreenSharingAborted: (() -> Unit)? = null) = shareScreen(context, Inputs.Type.Application, onScreenSharingStarted, onScreenSharingAborted)

    fun shareDeviceScreen(
        context: Context,
        onScreenSharingStarted: (() -> Unit)? = null,
        onScreenSharingAborted: (() -> Unit)? = null) = shareScreen(context, Inputs.Type.Screen, onScreenSharingStarted, onScreenSharingAborted)
