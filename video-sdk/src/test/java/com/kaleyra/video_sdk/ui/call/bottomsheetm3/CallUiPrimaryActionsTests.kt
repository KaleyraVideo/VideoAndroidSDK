...
class CallUiPrimaryActionsTests {
    ...
    fun testPortraitPrimaryActionsWidthTwoItems() {
        val itemsWidth = (1..2).map { portraitActionWidth(maxWidth = 1000.dp, itemsPerRow = 2, index = it) }
        Assert.assertEquals(true, itemsWidth.all { it == 405.dp })
    }

    @Test
    fun testPortraitPrimaryActionsWidthThreeItems() {
        val itemsWidth = (1..3).map { portraitActionWidth(maxWidth = 1000.dp, itemsPerRow = 3, index = it) }
    ...
    fun testPortraitPrimaryActionsWidthFourItems() {
        val itemsWidth = (1..4).map { portraitActionWidth(maxWidth = 1000.dp, itemsPerRow = 4, index = it) }
    ...
    fun testPortraitPrimaryActionsWidthFiveItems() {
        val itemsWidth = (1..5).map { portraitActionWidth(maxWidth = 1000.dp, itemsPerRow = 5, index = it) }
    ...
    fun testPortraitActionContainerWidthTwoActions() {
        ...
        Assert.assertEquals(500.dp, portraitActionContainerWidth(2, 2, maxWidth))
    }
    ...
    fun testPortraitActionContainerWidthThreeActions() {
        ...
        Assert.assertEquals(200.dp, portraitActionContainerWidth(2, 3, maxWidth))
        Assert.assertEquals(600.dp, portraitActionContainerWidth(3, 3, maxWidth))
    }
    ...
    fun testPortraitActionContainerWidthFourActions() {
        ...
        Assert.assertEquals(200.dp, portraitActionContainerWidth(3, 4, maxWidth))
        Assert.assertEquals(400.dp, portraitActionContainerWidth(4, 4, maxWidth))
    }
    ...
    fun testPortraitActionContainerWidthFiveActions() {
        ...
        Assert.assertEquals(200.dp, portraitActionContainerWidth(5, 5, maxWidth))
    }
}