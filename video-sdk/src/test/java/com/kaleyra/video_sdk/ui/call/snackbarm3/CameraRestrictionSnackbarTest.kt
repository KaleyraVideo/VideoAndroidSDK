...
import com.kaleyra.video_sdk.common.snackbar.view.CameraRestrictionSnackbarM3
...
class CameraRestrictionSnackbarM3Test {
    ...
    fun testCameraRestrictionSnackbar() {
        composeTestRule.setContent { CameraRestrictionSnackbarM3({}) }
